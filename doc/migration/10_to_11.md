...
- The `QuillSearchConfig` and search within embed objects feature is **now experimental**, which means it can be removed or changed later. Related [#2090](https://github.com/singerdmx/flutter-quill/pull/2090).