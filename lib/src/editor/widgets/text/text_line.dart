...
class _TextLineState extends State<TextLine> {
  ...
  TextStyle _getLineStyle(DefaultStyles defaultStyles) {
    ...
    if (isPlaceholderLine) {
      ...
      final placeholderStyle =
          widget.placeholderTextStyle ?? defaultStyles.placeHolder!.style;
  ...
  TextStyle _getInlineTextStyle(
    ...
    final hasMention =
        mention != null && mention.value != null && mention.value is Map;
    ...
    final hasCurrency =
        currency != null && currency.value != null && currency.value is Map;
